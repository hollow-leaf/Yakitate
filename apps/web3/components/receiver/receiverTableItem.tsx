...
function ReceiverTableItem(props: food) {
  ...
  return (
    <>
        <div className="fooditem">
            ...
            <DetailButton amount={props.amount} id={props.id} name={props.name} provider={props.provider} total={props.total} url={props.url}/>
        </div>
    </>
  );
}

export default ReceiverTableItem;