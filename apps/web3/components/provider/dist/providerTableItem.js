...
var providerdetailButton_1 = require("./providerdetailButton");
        ...
        React.createElement("div", { className: "fooditem" },
            ...
            React.createElement("div", { className: "saletext" },
                ...
                React.createElement("p", { className: "mt-1 text-lg font-medium text-gray-900" },
                    "Amount: ",
                    props.amount)),
            React.createElement(providerdetailButton_1["default"], { amount: props.amount, id: props.id, name: props.name, provider: props.provider, total: props.total, url: props.url }))));
}
exports["default"] = ProviderTableItem;
